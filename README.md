# SHK Portal - Arabic Cybersecurity & Penetration Testing Hub 🛡️
## منصة بوابة SHK - المركز العربي للأمن السيبراني واختبار الاختراق

![License](https://img.shields.io/badge/License-Free-brightgreen)
![Category](https://img.shields.io/badge/Category-Cybersecurity-red)
![Platform](https://img.shields.io/badge/Platform-PWA--IPFS-blue)

### 🌐 About SHK Portal | عن المنصة
**SHK Portal** is a leading Arabic educational and training platform specialized in **Cybersecurity and Penetration Testing**. Developed by **SHK** (a random 3-letter pseudonym), the platform aims to break the financial barriers to high-quality security education by providing professional content for free.

**بوابة SHK** هي منصة تعليمية وتدريبية رائدة باللغة العربية متخصصة في **الأمن السيبراني واختبار الاختراق**. صممها وطورها **SHK** (لقب مكون من أحرف عشوائية)، وتهدف المنصة لكسر حاجز التكاليف المرتفعة للمحتوى التعليمي الأمني عبر تقديم محتوى احترافي مجاني بالكامل.

---

### 🚀 Key Features | المميزات الرئيسية
- **PWA Ready:** Installable on Mobile & Desktop for a seamless experience.
- **Decentralized:** Compatible with **IPFS** for resilient hosting.
- **Community Driven:** Integrated with a professional Telegram community for experts and beginners.

- **تطبيق ويب تقدمي (PWA):** يمكن تثبيتها على الهواتف والكمبيوتر لتجربة مستخدم سلسة.
- **لامركزية:** متوافقة مع تقنيات **IPFS** لضمان استمرارية الاستضافة.
- **مجتمع تفاعلي:** مرتبطة بمجتمع احترافي على تليجرام يضم الخبراء والمبتدئين.

---

### 📁 Platform Sections | أقسام المنصة التفصيلية
